"""Omarchy theme palettes (colors.toml from basecamp/omarchy, quattro branch).

Generated — do not edit by hand. Regenerate from the upstream themes/*/colors.toml.
"""

# fmt: off
OMARCHY_PALETTES: dict[str, dict[str, str]] = {'catppuccin-latte': {'mode': 'light',
                      'accent': '#1e66f5',
                      'selection': '#ccd0da',
                      'muted': '#acb0be',
                      'background': '#eff1f5',
